...
package com.patrikagroup.faceRec;
...
import com.patrikagroup.faceRec.env.ImageUtils;
  ...
  private void requestPermission() {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
      if (shouldShowRequestPermissionRationale(PERMISSION_CAMERA)) {
        Toast.makeText(
                CameraActivity.this,
                "Camera permission is required for this patrikagroup",
                Toast.LENGTH_LONG)
            .show();
      }
      if (shouldShowRequestPermissionRationale(PERMISSION_EXTERNAL)) {
        Toast.makeText(
                CameraActivity.this,
                "Read permission is required for this patrikagroup",
                Toast.LENGTH_LONG)
                .show();
      }
