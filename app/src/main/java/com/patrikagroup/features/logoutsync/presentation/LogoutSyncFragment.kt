...
import com.patrikagroup.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.patrikagroup.features.billing.api.AddBillingRepoProvider
import com.patrikagroup.features.billing.model.AddBillingInputParamsModel
...
import com.patrikagroup.features.dashboard.presentation.ReasonDialog
...
import com.patrikagroup.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.patrikagroup.features.orderhistory.model.*
...
import com.patrikagroup.features.quotation.model.AddQuotInputModel
import com.patrikagroup.features.shopdetail.presentation.api.EditShopRepoProvider
import com.patrikagroup.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.patrikagroup.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.patrikagroup.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.patrikagroup.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.patrikagroup.features.timesheet.model.AddTimeSheetInputModel
...
import com.patrikagroup.features.returnsOrder.ReturnRequest
import com.patrikagroup.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xpatrikagrouplogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xpatrikagrouplogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xpatrikagrouplogsample/log.zip").path);
