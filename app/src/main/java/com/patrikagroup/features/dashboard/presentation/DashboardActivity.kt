...
import com.patrikagroup.app.NewFileUtils.browseDocuments
import com.patrikagroup.app.NewFileUtils.getExtension
import com.patrikagroup.app.domain.*
import com.patrikagroup.app.types.DashboardType
import com.patrikagroup.app.types.FragType
import com.patrikagroup.app.types.TopBarConfig
import com.patrikagroup.app.uiaction.DisplayAlert
import com.patrikagroup.app.utils.*
import com.patrikagroup.app.utils.AppUtils.Companion.isProfile
...
import com.patrikagroup.features.NewQuotation.*
import com.patrikagroup.features.NewQuotation.api.GetQuotRegProvider
import com.patrikagroup.features.NewQuotation.model.ViewDetailsQuotResponse
import com.patrikagroup.features.SearchLocation.SearchLocationFragment
import com.patrikagroup.features.SearchLocation.locationInfoModel
import com.patrikagroup.features.TA.ViewAllTAListFragment
import com.patrikagroup.features.achievement.AchievementFragment
import com.patrikagroup.features.activities.presentation.*
import com.patrikagroup.features.addAttendence.*
...
import com.patrikagroup.features.addAttendence.model.GetReportToResponse
import com.patrikagroup.features.addAttendence.model.Leave_list_Response
import com.patrikagroup.features.addorder.presentation.AddOrderFragment
...
import com.patrikagroup.features.addshop.presentation.AddShopFragment
import com.patrikagroup.features.addshop.presentation.OTPVerificationDialog
import com.patrikagroup.features.addshop.presentation.ScanImageFragment
import com.patrikagroup.features.addshop.presentation.ShowCardDetailsDialog
import com.patrikagroup.features.alarm.model.AlarmData
import com.patrikagroup.features.alarm.presetation.AttendanceReportFragment
import com.patrikagroup.features.alarm.presetation.PerformanceReportFragment
import com.patrikagroup.features.alarm.presetation.VisitReportDetailsFragment
import com.patrikagroup.features.alarm.presetation.VisitReportFragment
import com.patrikagroup.features.attendance.AttendanceFragment
import com.patrikagroup.features.attendance.api.AttendanceRepositoryProvider
import com.patrikagroup.features.attendance.model.AttendanceRequest
import com.patrikagroup.features.attendance.model.AttendanceResponse
import com.patrikagroup.features.averageshop.presentation.AverageShopFragment
import com.patrikagroup.features.avgorder.presentation.AverageOrderFragment
import com.patrikagroup.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.patrikagroup.features.beatCustom.TeamBeatListFragment
import com.patrikagroup.features.billing.presentation.AddBillingFragment
import com.patrikagroup.features.billing.presentation.BillingDetailsFragment
import com.patrikagroup.features.billing.presentation.BillingListFragment
import com.patrikagroup.features.changepassword.presentation.ChangePasswordDialog
import com.patrikagroup.features.chat.model.ChatListDataModel
import com.patrikagroup.features.chat.model.ChatUserDataModel
import com.patrikagroup.features.chat.model.GroupUserDataModel
import com.patrikagroup.features.chat.presentation.*
import com.patrikagroup.features.chatbot.presentation.ChatBotFragment
import com.patrikagroup.features.chatbot.presentation.ChatBotShopListFragment
import com.patrikagroup.features.chatbot.presentation.ReportsFragment
import com.patrikagroup.features.chatbot.presentation.SelectLanguageDialog
import com.patrikagroup.features.commondialog.presentation.CommonDialog
import com.patrikagroup.features.commondialog.presentation.CommonDialogClickListener
import com.patrikagroup.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
...
import com.patrikagroup.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.patrikagroup.features.dailyPlan.prsentation.AllShopListFragment
import com.patrikagroup.features.dailyPlan.prsentation.DailyPlanListFragment
import com.patrikagroup.features.dailyPlan.prsentation.PlanDetailsFragment
import com.patrikagroup.features.damageProduct.ShopDamageProductListFrag
import com.patrikagroup.features.damageProduct.ShopDamageProductSubmitFrag
import com.patrikagroup.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.patrikagroup.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.patrikagroup.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.patrikagroup.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.patrikagroup.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.patrikagroup.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.patrikagroup.features.dashboard.presentation.model.ContentListResponseModel
import com.patrikagroup.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.patrikagroup.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.patrikagroup.features.device_info.presentation.DeviceInfoListFragment
import com.patrikagroup.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.patrikagroup.features.document.DocumentRepoFeatureNewFragment
import com.patrikagroup.features.document.presentation.DocumentListFragment
import com.patrikagroup.features.document.presentation.DocumentTypeListFragment
import com.patrikagroup.features.document.presentation.OpenFileWebViewFragment
import com.patrikagroup.features.dymanicSection.presentation.AddDynamicFragment
import com.patrikagroup.features.dymanicSection.presentation.AllDynamicListFragment
import com.patrikagroup.features.dymanicSection.presentation.DynamicListFragment
import com.patrikagroup.features.dymanicSection.presentation.EditDynamicFragment
import com.patrikagroup.features.gpsDisabilityScreen.GpsDisableFragment
import com.patrikagroup.features.home.presentation.HomeFragment
import com.patrikagroup.features.homelocation.presentation.HomeLocationFragment
import com.patrikagroup.features.homelocation.presentation.HomeLocationMapFragment
import com.patrikagroup.features.know_your_state.KnowYourStateFragment
import com.patrikagroup.features.lead.LeadFrag
import com.patrikagroup.features.lead.ViewLeadFrag
import com.patrikagroup.features.leaveapplynew.LeaveHome
import com.patrikagroup.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.patrikagroup.features.localshops.LocalShopListFragment
import com.patrikagroup.features.localshops.LocalShopListMapFragment
import com.patrikagroup.features.localshops.NearByShopsMapFragment
import com.patrikagroup.features.location.*
import com.patrikagroup.features.location.api.LocationRepoProvider
...
import com.patrikagroup.features.login.ShopFeedbackEntity
import com.patrikagroup.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.patrikagroup.features.login.presentation.LoginActivity
import com.patrikagroup.features.logout.presentation.api.LogoutRepositoryProvider
import com.patrikagroup.features.logoutsync.presentation.LogoutSyncFragment
import com.patrikagroup.features.marketing.presentation.MarketingPagerFragment
import com.patrikagroup.features.meetinglist.prsentation.MeetingListFragment
import com.patrikagroup.features.member.MapViewForTeamFrag
import com.patrikagroup.features.member.model.TeamLocDataModel
import com.patrikagroup.features.member.model.TeamShopListDataModel
import com.patrikagroup.features.member.presentation.*
import com.patrikagroup.features.menuBeat.MenuBeatFrag
import com.patrikagroup.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.patrikagroup.features.micro_learning.presentation.MicroLearningListFragment
import com.patrikagroup.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.patrikagroup.features.myallowancerequest.MyallowanceRequestFragment
import com.patrikagroup.features.myjobs.model.CustomerDataModel
import com.patrikagroup.features.myjobs.presentation.*
import com.patrikagroup.features.myorder.presentation.MyOrderListFragment
import com.patrikagroup.features.myprofile.presentation.MyProfileFragment
import com.patrikagroup.features.nearbyshops.api.ShopListRepositoryProvider
import com.patrikagroup.features.nearbyshops.model.ShopData
import com.patrikagroup.features.nearbyshops.model.ShopListResponse
import com.patrikagroup.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.patrikagroup.features.nearbyshops.presentation.BeatListFragment
import com.patrikagroup.features.nearbyshops.presentation.NearByShopsListFragment
import com.patrikagroup.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.patrikagroup.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.patrikagroup.features.newcollection.CollectionDetailsStatusFragment
import com.patrikagroup.features.newcollection.CollectionShopListFragment
import com.patrikagroup.features.newcollection.NewCollectionListFragment
import com.patrikagroup.features.newcollectionreport.*
import com.patrikagroup.features.notification.NotificationFragment
import com.patrikagroup.features.orderList.NewDateWiseOrderListFragment
import com.patrikagroup.features.orderList.NewOrderListFragment
import com.patrikagroup.features.orderList.OrderListFragment
import com.patrikagroup.features.orderdetail.presentation.OrderDetailFragment
import com.patrikagroup.features.orderhistory.ActivityMapFragment
import com.patrikagroup.features.orderhistory.OrderhistoryFragment
import com.patrikagroup.features.orderhistory.TimeLineFragment
import com.patrikagroup.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.patrikagroup.features.orderhistory.model.FetchLocationRequest
import com.patrikagroup.features.orderhistory.model.FetchLocationResponse
import com.patrikagroup.features.orderhistory.model.LocationData
import com.patrikagroup.features.pendinglocationinout.PendingOutLocationFrag
import com.patrikagroup.features.performance.GpsStatusFragment
import com.patrikagroup.features.performance.PerformanceFragment
import com.patrikagroup.features.performance.api.UpdateGpsStatusRepoProvider
import com.patrikagroup.features.performance.model.UpdateGpsInputParamsModel
import com.patrikagroup.features.performanceAPP.PerformanceAppFragment
import com.patrikagroup.features.permissionList.ViewPermissionFragment
import com.patrikagroup.features.photoReg.*
import com.patrikagroup.features.privacypolicy.PrivacypolicyWebviewFrag
import com.patrikagroup.features.quotation.presentation.*
import com.patrikagroup.features.reimbursement.presentation.*
import com.patrikagroup.features.report.presentation.*
import com.patrikagroup.features.returnsOrder.*
import com.patrikagroup.features.settings.presentation.SettingsFragment
import com.patrikagroup.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.patrikagroup.features.shopdetail.presentation.*
import com.patrikagroup.features.shopdetail.presentation.api.EditShopRepoProvider
import com.patrikagroup.features.stock.StockDetailsFragment
import com.patrikagroup.features.stock.StockListFragment
import com.patrikagroup.features.stockAddCurrentStock.AddShopStockFragment
import com.patrikagroup.features.stockAddCurrentStock.UpdateShopStockFragment
import com.patrikagroup.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.patrikagroup.features.stockCompetetorStock.AddCompetetorStockFragment
import com.patrikagroup.features.stockCompetetorStock.CompetetorStockFragment
import com.patrikagroup.features.stockCompetetorStock.ViewComStockProductDetails
import com.patrikagroup.features.survey.SurveyFrag
import com.patrikagroup.features.survey.SurveyViewDtlsFrag
import com.patrikagroup.features.survey.SurveyViewFrag
import com.patrikagroup.features.task.presentation.AddTaskFragment
import com.patrikagroup.features.task.presentation.CalenderTaskFragment
import com.patrikagroup.features.task.presentation.EditTaskFragment
import com.patrikagroup.features.task.presentation.TaskListFragment
import com.patrikagroup.features.taskManagement.TaskManagementFrag
import com.patrikagroup.features.taskManagement.ViewTaskManagementFrag
import com.patrikagroup.features.timesheet.presentation.AddTimeSheetFragment
import com.patrikagroup.features.timesheet.presentation.EditTimeSheetFragment
import com.patrikagroup.features.timesheet.presentation.TimeSheetListFragment
import com.patrikagroup.features.viewAllOrder.CartFragment
import com.patrikagroup.features.viewAllOrder.OrderTypeListFragment
import com.patrikagroup.features.viewAllOrder.ViewAllOrderListFragment
import com.patrikagroup.features.viewAllOrder.ViewCartFragment
import com.patrikagroup.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.patrikagroup.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.patrikagroup.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
...
import com.patrikagroup.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.patrikagroup.features.viewPPDDStock.ViewOutstandingFragment
import com.patrikagroup.features.viewPPDDStock.ViewPPDDListFragment
import com.patrikagroup.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.patrikagroup.features.viewPPDDStock.ViewStockFragment
import com.patrikagroup.features.weather.presentation.WeatherFragment
import com.patrikagroup.mappackage.MapActivity
import com.patrikagroup.mappackage.MapActivityWithoutPath
...
import com.patrikagroup.app.NewFileUtils.browsePDFDocuments
import com.patrikagroup.features.marketAssist.MarketAssistTabFrag
import com.patrikagroup.features.marketAssist.ShopDtlsMarketAssistFrag
import com.patrikagroup.features.marketAssist.ShopListMarketAssistFrag
import com.patrikagroup.features.performanceAPP.OwnPerformanceFragment
import com.patrikagroup.features.performanceAPP.allPerformanceFrag
import com.patrikagroup.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xpatrikagrouplogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xpatrikagrouplogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.patrikagroup/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xpatrikagrouplogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xpatrikagrouplogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xpatrikagrouplogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xpatrikagrouplogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
